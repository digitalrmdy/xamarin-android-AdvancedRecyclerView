...
namespace Com.H6ah4i.Android.Widget.Advrecyclerview.Utils
{
    public abstract partial class AbstractExpandableItemAdapter : global::Android.Support.V7.Widget.RecyclerView.Adapter, global::Com.H6ah4i.Android.Widget.Advrecyclerview.Expandable.IExpandableItemAdapter
    {
        ...
        [Register("onCreateChildViewHolder", "(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$ViewHolder;", "GetOnCreateChildViewHolder_Landroid_view_ViewGroup_IHandler:Com.H6ah4i.Android.Widget.Advrecyclerview.Expandable.IExpandableItemAdapterInvoker, x3factr.Platform.Droid.AdvancedRecyclerView")]
        ...
        [Register("onCreateGroupViewHolder", "(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$ViewHolder;", "GetOnCreateGroupViewHolder_Landroid_view_ViewGroup_IHandler:Com.H6ah4i.Android.Widget.Advrecyclerview.Expandable.IExpandableItemAdapterInvoker, x3factr.Platform.Droid.AdvancedRecyclerView")]
        ...
        [Register("onBindChildViewHolder", "(Landroid/support/v7/widget/RecyclerView$ViewHolder;III)V", "GetOnBindChildViewHolder_Landroid_support_v7_widget_RecyclerView_ViewHolder_IIIHandler:Com.H6ah4i.Android.Widget.Advrecyclerview.Expandable.IExpandableItemAdapterInvoker, x3factr.Platform.Droid.AdvancedRecyclerView")]
        ...
        [Register("onBindGroupViewHolder", "(Landroid/support/v7/widget/RecyclerView$ViewHolder;II)V", "GetOnBindGroupViewHolder_Landroid_support_v7_widget_RecyclerView_ViewHolder_IIHandler:Com.H6ah4i.Android.Widget.Advrecyclerview.Expandable.IExpandableItemAdapterInvoker, x3factr.Platform.Droid.AdvancedRecyclerView")]
